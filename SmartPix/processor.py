...
class SmartPixProcessor:
    def __init__(self, 
        ...
        self.collator = SmartPixCollator()
        self.separate_collator = SmartPixSeparateCollator()
...
class SmartPixSeparateCollator(SmartPixCollator):
    def __call__(self, features):
        mllm_inputs = [f[0] for f in features]
        cfg_mllm_inputs = [f[1] for f in features]
        img_cfg_mllm_input = [f[2] for f in features]
