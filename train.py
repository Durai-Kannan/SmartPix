...
from SmartPix import SmartPix, SmartPixProcessor
from SmartPix.train_helper import DatasetFromJson, TrainDataCollator
from SmartPix.train_helper import training_losses
from SmartPix.utils import (
    create_logger,
    update_ema,
    requires_grad,
    center_crop_arr,
...
def main(args):
    ...
    model = SmartPix.from_pretrained(args.model_name_or_path)
    ...
    processor = SmartPixProcessor.from_pretrained(args.model_name_or_path)
